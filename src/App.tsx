    ...
    <main className="login-page">
      <section className="login-card" aria-labelledby="login-title">
        ...
        <form onSubmit={submit}>
          ...
          <nav className="login-links" aria-label="Opções de acesso"><button type="button">Esqueceu a senha?</button><button type="button">Criar conta</button></nav>
        </form>
...
function App() {
  ...
  return loggedIn ? <VeterinarianArea onLogout={() => setLoggedIn(false)} /> : <Login onLogin={() => setLoggedIn(true)} />
}
